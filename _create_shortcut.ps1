...
# Start Menu shortcut
$shortcutPath = "$env:APPDATA\Microsoft\Windows\Start Menu\Programs\Claudeborn.lnk"
...
$shortcut.Description = "Claudeborn - Claude Code Command Center"
$shortcut.WindowStyle = 7
$shortcut.Save()

# Desktop shortcut
$desktopPath = "$env:USERPROFILE\Desktop\Claudeborn.lnk"
...
$shortcut2.Description = "Claudeborn - Claude Code Command Center"
