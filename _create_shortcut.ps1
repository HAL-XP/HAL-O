...
$shortcut.Arguments = '/c "cd /d D:\GitHub\hal-o && npx electron-vite dev"'
$shortcut.WorkingDirectory = "D:\GitHub\hal-o"
$shortcut.IconLocation = "D:\GitHub\hal-o\resources\icon.ico,0"
...
$shortcut2.Arguments = '/c "cd /d D:\GitHub\hal-o && npx electron-vite dev"'
$shortcut2.WorkingDirectory = "D:\GitHub\hal-o"
$shortcut2.IconLocation = "D:\GitHub\hal-o\resources\icon.ico,0"
