...
export function SettingsMenu({
  ...
  return (<div ref={ref} style={{ position: 'relative' }}>
    ...
    {open && createPortal(
      <div className="hal-settings-panel" ref={panelRef} style={(() => { const rect = ref.current?.getBoundingClientRect(); const font = '11px'; if (!rect) return { '--hub-font': font } as React.CSSProperties; return { position: 'fixed' as const, top: rect.bottom + 6, right: window.innerWidth - rect.right, '--hub-font': font } as React.CSSProperties })()}>
