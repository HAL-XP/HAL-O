...
export function SettingsMenu({
  ...
  return (<div ref={ref} style={{ position: 'relative' }}>
    ...
    {open && createPortal(
      <div className="hal-settings-panel" ref={panelRef} style={(() => { const rect = ref.current?.getBoundingClientRect(); if (!rect) return { '--hub-font': hubFontSize + 'px' } as React.CSSProperties; return { position: 'fixed' as const, top: rect.bottom + 6, right: window.innerWidth - rect.right, '--hub-font': hubFontSize + 'px' } as React.CSSProperties })()}>
