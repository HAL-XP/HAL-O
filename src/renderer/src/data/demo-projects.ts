...
export const DEMO_PROJECTS: ProjectInfo[] = [
  // ── hal-o-enhanced (10) ──
  {
    ...
    hasClaude: true, hasBatchFiles: true, hasClaudeDir: true, hasHalOMeta: true,
    configLevel: 'hal-o-enhanced',
    lastModified: spreadTimestamp(0),
    gitOwner: 'astralworks', runCmd: 'cargo run --release',
  ...
  },
  {
    ...
    gitOwner: 'meshworks', runCmd: 'go run .',
  ...
  },
  {
    ...
    gitOwner: 'deepforge', runCmd: 'python train.py',
  ...
  },
  {
    ...
    gitOwner: 'forgeai', runCmd: 'python -m forge.train',
  ...
  },
  {
    ...
    gitOwner: 'plasmadesign', runCmd: 'npm run dev',
  ...
  },
  {
    ...
    gitOwner: 'cipherx', runCmd: 'cargo run',
  ...
  },
  {
    ...
    gitOwner: 'auroraui', runCmd: 'npm run dev',
  ...
  },
  {
    ...
    gitOwner: 'obsidiantools', runCmd: 'npm start',
  ...
  },
  {
    ...
    gitOwner: 'tempestdev', runCmd: 'cargo run -- --help',
  ...
  },
  {
    ...
    gitOwner: 'axiomOS', runCmd: 'make qemu',
  ...
  // ── claude-aware (15) ──
  {
    ...
    hasClaude: true, hasBatchFiles: true, hasClaudeDir: true, hasHalOMeta: false,
    configLevel: 'claude-aware',
    lastModified: spreadTimestamp(2),
    gitOwner: 'phoenix-labs', runCmd: 'mix phx.server',
  ...
  },
  {
    ...
    hasClaude: true, hasBatchFiles: false, hasClaudeDir: true, hasHalOMeta: false,
    configLevel: 'claude-aware',
    lastModified: spreadTimestamp(5),
    gitOwner: 'cosmicdata', runCmd: '',
  ...
  },
  {
    ...
    gitOwner: 'vortexio', runCmd: './gradlew run',
  ...
  },
  {
    ...
    gitOwner: 'zenithweb', runCmd: 'npm run dev',
  ...
  },
  {
    ...
    gitOwner: 'crimsonsec', runCmd: 'python manage.py runserver',
  ...
  },
  {
    ...
    gitOwner: 'solsticeml', runCmd: 'python inference.py',
  ...
  },
  {
    ...
    gitOwner: 'echolabs', runCmd: 'npm start',
  ...
  },
  {
    ...
    gitOwner: 'monolithsys', runCmd: './mvnw spring-boot:run',
  ...
  },
  {
    ...
    hasClaude: true, hasBatchFiles: true, hasClaudeDir: false, hasHalOMeta: false,
    configLevel: 'claude-aware',
    lastModified: spreadTimestamp(21),
    gitOwner: 'starfieldgames', runCmd: '',
  ...
  },
  {
    ...
    gitOwner: 'prismdata', runCmd: 'python -m prism.server',
  ...
  },
  {
    ...
    gitOwner: 'halcyondesign', runCmd: 'npm run dev',
  ...
  },
  {
    ...
    gitOwner: 'sentinelio', runCmd: 'go run cmd/sentinel/main.go',
  ...
  },
  {
    ...
    gitOwner: 'cascadedata', runCmd: 'python -m cascade.run',
  ...
  // ── bare (5) ──
  {
    ...
    stack: 'Zig + WebGPU',
    hasClaude: false, hasBatchFiles: false, hasClaudeDir: false, hasHalOMeta: false,
    configLevel: 'bare',
    lastModified: spreadTimestamp(8),
    gitOwner: 'darklabs', runCmd: '',
