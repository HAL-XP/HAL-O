...
export const STACK_PROFILES: StackProfile[] = [
  // ── Web / Frontend ──
  {
    ...
    extras: ['playwright-mcp', 'agent-templates', 'memory-seed', 'readme', 'skip-permissions'],
  ...
  },
  {
    ...
    extras: ['playwright-mcp', 'memory-seed', 'readme', 'skip-permissions'],
    agentTypes: ['qa'],
  ...
  // ── Desktop ──
  {
    ...
    playwright: false, hooks: ['session-start', 'post-tool-tsc'],
    rules: ['frontend', 'ux', 'banned-techniques'],
    extras: ['agent-templates', 'memory-seed', 'readme', 'skip-permissions'],
    agentTypes: ['frontend', 'qa'],
    cloudSuggestions: [],
    mcpServers: [],
